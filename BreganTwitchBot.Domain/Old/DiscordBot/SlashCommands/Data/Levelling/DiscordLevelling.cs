...
namespace BreganTwitchBot.Domain.Bot.DiscordBot.SlashCommands.Data.Levelling
{
    internal class DiscordLevelling
    {
        ...
        private static async Task CheckIfLevelledUp(ulong discordUserId, ulong discordChannel)
        {
            ...
            using (var context = new DatabaseContext())
            {
                notifsEnabled = context.Users.Where(x => x.DiscordUserId == discordUserId).First().DiscordLevelUpNotifsEnabled;
            }
