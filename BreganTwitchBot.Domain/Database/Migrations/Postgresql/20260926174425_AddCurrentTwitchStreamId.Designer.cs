...
namespace BreganTwitchBot.Domain.Database.Migrations.Postgresql
{
    ...
    [Migration("20260926174425_AddCurrentTwitchStreamId")]
    partial class AddCurrentTwitchStreamId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BreganTwitchBot.Domain.Database.Models.ChannelConfig", b =>
                {
                    ...
                    b.Property<string>("CurrentTwitchStreamId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BreganTwitchBot.Domain.Database.Models.DiscordWordleGame", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.PrimitiveCollection<List<string>>("Guesses")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.HasIndex("ChannelId", "DiscordUserId", "Date")
                        .IsUnique();

                    b.ToTable("DiscordWordleGames");
                });
