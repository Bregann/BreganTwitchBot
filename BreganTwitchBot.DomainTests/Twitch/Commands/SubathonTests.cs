...
namespace BreganTwitchBot.DomainTests.Twitch.Commands
{
    ...
    public class SubathonTests
    {
        ...
        public async Task AddBitsTime_UnderTwelveHours_UsesTopRate()
        {
            ...
            await _subathonDataService.AddBitsTime(DatabaseSeedHelper.Channel1BroadcasterTwitchChannelId, DatabaseSeedHelper.Channel1User1TwitchUserId, 100);
        ...
        public async Task AddBitsTime_LargeCheer_CompletesWithoutLooping()
        {
            ...
            await _subathonDataService.AddBitsTime(DatabaseSeedHelper.Channel1BroadcasterTwitchChannelId, DatabaseSeedHelper.Channel1User1TwitchUserId, 500000);
        ...
        public async Task AddSubTime_Tier1UnderTwelveHours_AddsSixMinutes()
        {
            ...
            await _subathonDataService.AddSubTime(DatabaseSeedHelper.Channel1BroadcasterTwitchChannelId, DatabaseSeedHelper.Channel1User1TwitchUserId, SubTierEnum.Tier1);
        ...
        public async Task AddSubTime_Tier3UnderTwelveHours_AddsThirtyMinutes()
        {
            ...
            await _subathonDataService.AddSubTime(DatabaseSeedHelper.Channel1BroadcasterTwitchChannelId, DatabaseSeedHelper.Channel1User1TwitchUserId, SubTierEnum.Tier3);
        ...
        public async Task AddSubTime_MultipleGiftedSubs_AddsForEach()
        {
            ...
            await _subathonDataService.AddSubTime(DatabaseSeedHelper.Channel1BroadcasterTwitchChannelId, DatabaseSeedHelper.Channel1User1TwitchUserId, SubTierEnum.Tier1, 5);
        ...
        public async Task Contributions_AreTrackedPerUser()
        {
            ...
            await _subathonDataService.AddBitsTime(DatabaseSeedHelper.Channel1BroadcasterTwitchChannelId, DatabaseSeedHelper.Channel1User1TwitchUserId, 100);
            await _subathonDataService.AddSubTime(DatabaseSeedHelper.Channel1BroadcasterTwitchChannelId, DatabaseSeedHelper.Channel1User1TwitchUserId, SubTierEnum.Tier1, 2);
        ...
        {
            var response = await _subathonDataService.StartSubathon(CreateMsgParams("!startsubathon"));
        ...
        {
            await _subathonDataService.StartSubathon(CreateMsgParams("!startsubathon 5"));
        ...
        public async Task StopSubathon_SetsInactive()
        {
            ...
            var response = await _subathonDataService.StopSubathon(CreateMsgParams("!stopsubathon"));
        ...
        public async Task AddTimeManually_AddsTheSeconds()
        {
            ...
            await _subathonDataService.AddTimeManually(CreateMsgParams("!addsubathontime 300"));
        ...
        public void AddTimeManually_NoSeconds_ThrowsInvalidCommand()
        {
            Assert.ThrowsAsync<InvalidCommandException>(async () =>
                await _subathonDataService.AddTimeManually(CreateMsgParams("!addsubathontime")));
        }
        ...
        {
            Assert.ThrowsAsync<InvalidCommandException>(async () =>
                await _subathonDataService.AddTimeManually(CreateMsgParams("!addsubathontime abc")));
        }

        [Test]
        public async Task GetStatus_NoSubathonRunning_SaysSo()
        {
            var response = await _subathonDataService.GetSubathonStatus(CreateMsgParams("!subathon"));
        ...
        public async Task SubathonOnAnotherChannel_IsNotAffected()
        {
            ...
            await _subathonDataService.AddBitsTime(DatabaseSeedHelper.Channel2BroadcasterTwitchChannelId, DatabaseSeedHelper.Channel2User1TwitchUserId, 100);
