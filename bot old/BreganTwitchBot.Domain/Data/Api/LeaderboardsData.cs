...
namespace BreganTwitchBot.Domain.Data.Api
{
    ...
    {
        public static List<LeaderboardDto> GetLeaderboard(LeaderboardType leaderboardType)
        {
            using (var context = new DatabaseContext())
            {
                var lb = new List<LeaderboardDto>();
                ...
                {
                    lb.Add(new LeaderboardDto
                    {
                        Username = user.Key,
                        Position = pos,
                        Amount = user.Value.ToString("N0")
                    });
        ...
        public static List<LeaderboardDto> GetHourLeaderboard(LeaderboardType type)
        {
            using (var context = new DatabaseContext())
            {
                var lb = new List<LeaderboardDto>();
