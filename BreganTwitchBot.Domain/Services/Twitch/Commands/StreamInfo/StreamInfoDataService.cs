...
namespace BreganTwitchBot.Domain.Services.Twitch.Commands.StreamInfo
{
    ...
    {
        public async Task<string> GetFollowerCountAsync(ChannelChatMessageReceivedParams msgParams)
        {
        ...
        public async Task<string> GetSubscriberCountAsync(ChannelChatMessageReceivedParams msgParams)
        {
