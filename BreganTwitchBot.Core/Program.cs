...
Log.Logger = new LoggerConfiguration().WriteTo.Async(x => x.File("Data/Logs/log.log", retainedFileCountLimit: null, rollingInterval: RollingInterval.Day)).WriteTo.Console().CreateLogger(); Log.Information("Logger Setup");
