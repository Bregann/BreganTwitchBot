...
namespace BreganTwitchBot.DomainTests.Twitch.Commands
{
    ...
    public class ChannelInfoTests
    {
        ...
        {
            var response = await _channelInfoDataService.GetTitleAsync(CreateMsgParams("!title", isMod: false));
        ...
        {
            var response = await _channelInfoDataService.GetGameAsync(CreateMsgParams("!game", isMod: false));
        ...
        public async Task GetTitle_NoBroadcasterClient_ReturnsErrorMessage()
        {
            ...
            var response = await _channelInfoDataService.GetTitleAsync(CreateMsgParams("!title"));
        ...
        public async Task GetGame_ApiThrows_ReturnsErrorMessage()
        {
            ...
            var response = await _channelInfoDataService.GetGameAsync(CreateMsgParams("!game"));
        ...
        {
            var response = await _channelInfoDataService.SetTitleAsync(CreateMsgParams("!title a brand new title"), "a brand new title");
        ...
        public void SetTitle_AsNonMod_ThrowsUnauthorised()
        {
            ...
            Assert.ThrowsAsync<UnauthorizedAccessException>(async () =>
                await _channelInfoDataService.SetTitleAsync(CreateMsgParams("!title nope", isMod: false), "nope"));
        }
        ...
        public async Task SetGame_AsMod_UpdatesGameAndKeepsTitle()
        {
            ...
            var response = await _channelInfoDataService.SetGameAsync(CreateMsgParams("!game Minecraft"), "Minecraft");
        ...
        public async Task SetGame_UnknownGame_ReturnsNotFoundAndDoesNotUpdate()
        {
            ...
            var response = await _channelInfoDataService.SetGameAsync(CreateMsgParams("!game notarealgame"), "notarealgame");
        ...
        public void SetGame_AsNonMod_ThrowsUnauthorised()
        {
            ...
            Assert.ThrowsAsync<UnauthorizedAccessException>(async () =>
                await _channelInfoDataService.SetGameAsync(CreateMsgParams("!game nope", isMod: false), "nope"));
        }

        [Test]
        public async Task SetTitle_AsBroadcaster_IsAllowed()
        {
            var response = await _channelInfoDataService.SetTitleAsync(CreateMsgParams("!title streamer title", isMod: false, isBroadcaster: true), "streamer title");
        ...
        public async Task SetTitle_ModifyThrows_ReturnsErrorMessage()
        {
            ...
            var response = await _channelInfoDataService.SetTitleAsync(CreateMsgParams("!title new title"), "new title");
