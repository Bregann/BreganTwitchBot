...
namespace BreganTwitchBot.DiscordBot.Helpers
{
    public class DiscordHelper
    {
        ...
        {
            var user = DiscordConnection.DiscordClient.GetGuild(Config.DiscordGuildID).GetUser(userId);
        ...
        {
            var channel = await DiscordConnection.DiscordClient.GetChannelAsync(Config.DiscordStreamAnnouncementChannelID) as IMessageChannel;
            await channel.SendMessageAsync($"Hey @everyone! {Config.BroadcasterName} is now live! Tune in at https://www.twitch.tv/{Config.BroadcasterName} !");
        }
