...
namespace BreganTwitchBot.Domain.Services.Twitch.Commands.Subathon
{
    ...
    {
        public async Task AddBitsTimeAsync(string broadcasterChannelId, string chatterChannelId, int bitsAmount)
        {
        ...
        public async Task AddSubTimeAsync(string broadcasterChannelId, string chatterChannelId, SubTierEnum subTier, int subCount = 1)
        {
            var config = await GetConfigIfSubathonActive(broadcasterChannelId);
        ...
        public async Task<string> AddTimeManuallyAsync(ChannelChatMessageReceivedParams msgParams)
        {
        ...
        public async Task<string> GetSubathonStatusAsync(ChannelChatMessageReceivedParams msgParams)
        {
            var config = await GetConfigIfSubathonActive(msgParams.BroadcasterChannelId);
        ...
        public async Task<string> StartSubathonAsync(ChannelChatMessageReceivedParams msgParams)
        {
            await twitchHelperService.EnsureUserHasModeratorPermissions(msgParams.IsMod, msgParams.IsBroadcaster, msgParams.ChatterChannelName, msgParams.ChatterChannelId, msgParams.BroadcasterChannelId, msgParams.BroadcasterChannelName);
        ...
        public async Task<string> StopSubathonAsync(ChannelChatMessageReceivedParams msgParams)
        {
            await twitchHelperService.EnsureUserHasModeratorPermissions(msgParams.IsMod, msgParams.IsBroadcaster, msgParams.ChatterChannelName, msgParams.ChatterChannelId, msgParams.BroadcasterChannelId, msgParams.BroadcasterChannelName);
