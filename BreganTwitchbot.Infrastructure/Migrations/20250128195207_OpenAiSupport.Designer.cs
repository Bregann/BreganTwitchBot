...
namespace BreganTwitchBot.Infrastructure.Migrations
{
    ...
    [Migration("20250128195207_OpenAiSupport")]
    partial class OpenAiSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BreganTwitchBot.Infrastructure.Database.Models.AiBookData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AiBookData", "twitchbot_new");
                });
            ...
            modelBuilder.Entity("BreganTwitchBot.Infrastructure.Database.Models.Config", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HangfirePassword = "",
                            HangfireUsername = "",
                            LastDailyPointsAllowed = new DateTime(2025, 1, 27, 19, 52, 6, 926, DateTimeKind.Utc).AddTicks(7659),
                            OpenAiApiKey = "",
                            PinnedStreamDate = new DateTime(2025, 1, 27, 19, 52, 6, 926, DateTimeKind.Utc).AddTicks(7655),
                            PinnedStreamMessage = "",
