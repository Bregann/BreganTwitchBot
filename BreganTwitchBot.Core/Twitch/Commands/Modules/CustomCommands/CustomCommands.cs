...
namespace BreganTwitchBot.Core.Twitch.Commands.Modules.CustomCommands
{
    public class CustomCommands
    {
        public static void HandleAddCommand(OnChatCommandReceivedArgs command)
        {
            ...
            using (var context = new DatabaseContext())
            {
                context.Commands.Add(new Data.Models.Commands
                {
        ...
        public static void HandleEditCommandCommand(OnChatCommandReceivedArgs command)
        {
            ...
            using (var context = new DatabaseContext())
            {
                context.Commands.Update(new Data.Models.Commands
                {
                    CommandName = commandName,
                    CommandText = commandText
                });
