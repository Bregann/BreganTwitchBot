...
namespace BreganTwitchBot.Core.Twitch.Commands.Modules.Gambling
{
    public class Gambling
    {
        ...
        public static async Task HandleGamblingCommand(OnChatCommandReceivedArgs command)
        {
            ...
            //Check the cooldown
            if (DateTime.Now - TimeSpan.FromSeconds(5) <= _gamblingCooldown && !SuperMods.SuperMods.IsUserSupermod(command.Command.ChatMessage.Username.ToLower()))
            {
            ...
            {
                TwitchHelper.SendMessage($"@{command.Command.ChatMessage.Username} => try using !spin <{Config.PointsName}> or !spin all. Remember it is 100 points minimum!");
                return;
            }
            ...
            {
                TwitchHelper.SendMessage($"You don't have enough {Config.PointsName}! You only have {userPoints}");
                return;
            }
            ...
            _gamblingCooldown = DateTime.Now;
        }
        ...
        public static void HandleSpinStatsCommand(string username)
        {
            ...
            {
                var spinStats = context.SlotMachine.Where(x => x.StreamName == Config.BroadcasterName).First();
        ...
        private static async Task SpinSlotMachine(string username, long pointsGambled)
        {
            ...
            switch (emoteList[0])
            {
                case "Kappa" when emoteList[1] == "Kappa" && emoteList[2] == "Kappa":
                    ...
                    TwitchHelper.SendMessage($"@{username} => You have spun {emoteList[0]} | {emoteList[1]} | {emoteList[2]}. You have won {pointsGambled * 10:N0} {Config.PointsName}!");
                ...
                case "4Head" when emoteList[1] == "4Head" && emoteList[2] == "4Head":
                    ...
                    TwitchHelper.SendMessage($"@{username} => You have spun {emoteList[0]} | {emoteList[1]} | {emoteList[2]}. You have won {pointsGambled * 20:N0} {Config.PointsName}!");
                ...
                case "LUL" when emoteList[1] == "LUL" && emoteList[2] == "LUL":
                    ...
                    TwitchHelper.SendMessage($"@{username} => You have spun {emoteList[0]} | {emoteList[1]} | {emoteList[2]}. You have won {pointsGambled * 40:N0} {Config.PointsName}!");
                ...
                case "TriHard" when emoteList[1] == "TriHard" && emoteList[2] == "TriHard":
                    {
                        ...
                        using (var context = new DatabaseContext())
                        {
                            context.SlotMachine.Where(x => x.StreamName == Config.BroadcasterName).First().JackpotAmount = 50000;
                            context.SaveChanges();
                        }

                        TwitchHelper.SendMessage($"@{username} => You have spun {emoteList[0]} | {emoteList[1]} | {emoteList[2]}. DING DING DING JACKPOT!!! You have won {jackpotAmount:N0} {Config.PointsName}!");
                ...
                case "SMOrc" when emoteList[1] == "SMOrc" && emoteList[2] == "SMOrc":
                    {
                        ...
                        TwitchHelper.SendMessage($"@{username} => You have spun {emoteList[0]} | {emoteList[1]} | {emoteList[2]}. DING DING DING BUDGET JACKPOT!!! You have won the grand total of 1 WHOLE {Config.PointsName} PogChamp PogChamp PogChamp PogChamp PogChamp PogChamp PogChamp PogChamp PogChamp PogChamp PogChamp PogChamp PogChamp PogChamp ");
        ...
        private static void AddWinToSlotMachineAndUser(string username, string winType, long pointsGambled, long pointsWon)
        {
            using (var context = new DatabaseContext())
            {
                ...
                context.SlotMachine.Update(spinStats);
                context.SaveChanges();
            }
        }
        ...
        private static long GetJackpotAmount()
        {
            using (var context = new DatabaseContext())
            {
                return context.SlotMachine.Where(x => x.StreamName == Config.BroadcasterName).First().JackpotAmount;
            }
        }
    }
}
