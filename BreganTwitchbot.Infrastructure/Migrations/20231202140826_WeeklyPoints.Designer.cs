...
namespace BreganTwitchBot.Infrastructure.Migrations
{
    ...
    [Migration("20231202140826_WeeklyPoints")]
    partial class WeeklyPoints
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BreganTwitchBot.Infrastructure.Database.Models.Config", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HangfirePassword = "",
                            HangfireUsername = "",
                            LastDailyPointsAllowed = new DateTime(2023, 12, 1, 14, 8, 25, 634, DateTimeKind.Utc).AddTicks(572),
                            PinnedStreamDate = new DateTime(2023, 12, 1, 14, 8, 25, 634, DateTimeKind.Utc).AddTicks(563),
                            PinnedStreamMessage = "",
