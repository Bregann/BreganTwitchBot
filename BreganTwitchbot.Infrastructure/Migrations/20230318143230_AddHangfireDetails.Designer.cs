...
namespace BreganTwitchBot.Infrastructure.Migrations
{
    ...
    [Migration("20230318143230_AddHangfireDetails")]
    partial class AddHangfireDetails
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BreganTwitchBot.Infrastructure.Database.Models.Config", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HangfirePassword = "",
                            HangfireUsername = "",
                            LastDailyPointsAllowed = new DateTime(2023, 3, 17, 14, 32, 30, 332, DateTimeKind.Utc).AddTicks(2093),
                            PinnedStreamDate = new DateTime(2023, 3, 17, 14, 32, 30, 332, DateTimeKind.Utc).AddTicks(2087),
                            PinnedStreamMessage = "",
